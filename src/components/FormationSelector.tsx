...
/**
 * Horizontal chip rail. Only the active chip deviates (fill + glow + colour) —
 * everything else is uniform, which is what makes the selection pop.
 */
  ...
  return (
    <section aria-label="Formation">
      <div className="mb-2 flex items-baseline justify-between px-4">
        <h2 className="label-micro">Formation</h2>
